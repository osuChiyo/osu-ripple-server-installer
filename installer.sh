...
echo ""
echo "IMPORTANT: Ripple is licensed under the GNU GPL license. This means, if your server is public, that ANY modification made to the original ripple code MUST be publically available."
